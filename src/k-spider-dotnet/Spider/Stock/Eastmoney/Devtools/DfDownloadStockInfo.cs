...
namespace KSpider.Spider.Stock;

public class DfDownloadStockInfo
{
    ...
    public static async Task<string> GetDatInfo22(string id)
    {
        using (var client = new HttpClient())
        {
            ...
            // 读取响应内容 : SSE 归档首帧只需第一行
            using var reader = new StreamReader(response);
            var ans = await reader.ReadLineAsync() ?? "";
    ...
    {
        var directory = "/home/kyssion/stokinfo_20240514";
