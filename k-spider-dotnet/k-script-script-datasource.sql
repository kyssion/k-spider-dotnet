...
ALTER FUNCTION public.update_time_func() OWNER TO spider;
...
ALTER TABLE public.spider_news_content OWNER TO spider;
...
ALTER SEQUENCE public.spider_news_content_id_seq OWNER TO spider;
...
ALTER TABLE public.spider_news_content_origin OWNER TO spider;
...
ALTER SEQUENCE public.spider_news_content_origin_id_seq OWNER TO spider;
...
ALTER TABLE public.spider_news_image_list OWNER TO spider;
...
ALTER SEQUENCE public.spider_news_image_list_id_seq OWNER TO spider;
...
ALTER TABLE public.spider_news_list OWNER TO spider;
...
ALTER SEQUENCE public.spider_news_list_id_seq OWNER TO spider;
...
ALTER TABLE public.stock_cn_introduction OWNER TO spider;
...
ALTER TABLE public.stock_cn_level1_archived_daily_origin OWNER TO spider;
...
ALTER SEQUENCE public.stock_cn_level1_archived_daliy_id_seq OWNER TO spider;
...
ALTER TABLE public.stock_hk_level1_archived_daily_origin OWNER TO spider;
...
ALTER SEQUENCE public.stock_hk_level1_archived_daliy_id_seq OWNER TO spider;
...
ALTER SEQUENCE public.stock_introduction_id_seq OWNER TO spider;
...
ALTER TABLE public.stock_usa_level1_archived_daliy_origin OWNER TO spider;
...
ALTER SEQUENCE public.stock_usa_level1_archived_daliy_id_seq OWNER TO spider;
